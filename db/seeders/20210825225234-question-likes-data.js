...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    return queryInterface.bulkInsert('QuestionLikes', [
      ...
      { vote: true, userId: 2, questionId: 14 },
      { vote: true, userId: 4, questionId: 14 },
      { vote: true, userId: 6, questionId: 14 },
      { vote: true, userId: 5, questionId: 14 },
      { vote: false, userId: 1, questionId: 14 },
      { vote: true, userId: 1, questionId: 15 },
      { vote: true, userId: 3, questionId: 15 },
      { vote: false, userId: 4, questionId: 15 },
      { vote: true, userId: 5, questionId: 15 },
      { vote: true, userId: 6, questionId: 15 },
      { vote: true, userId: 7, questionId: 1 },
      { vote: true, userId: 7, questionId: 2 },
      { vote: true, userId: 7, questionId: 3 },
      { vote: true, userId: 7, questionId: 4 },
      { vote: false, userId: 7, questionId: 5 },
      { vote: true, userId: 7, questionId: 6 },
      { vote: true, userId: 7, questionId: 7 },
      { vote: false, userId: 7, questionId: 8 },
      { vote: true, userId: 7, questionId: 9 },
      { vote: true, userId: 7, questionId: 10 }
    ], {});
  },
