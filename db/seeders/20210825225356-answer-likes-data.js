...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    return queryInterface.bulkInsert('AnswerLikes', [
      ...
      { vote: false, userId: 1, answerId: 23 },
      { vote: false, userId: 2, answerId: 24 },
      { vote: true, userId: 3, answerId: 25 },
      { vote: true, userId: 4, answerId: 26 },
      { vote: true, userId: 7, answerId: 27 },
      { vote: true, userId: 7, answerId: 28 },
      { vote: true, userId: 4, answerId: 23 },
      { vote: false, userId: 6, answerId: 24 },
      { vote: true, userId: 4, answerId: 25 },
      { vote: false, userId: 6, answerId: 26 },
      { vote: true, userId: 7, answerId: 27 },
      { vote: true, userId: 5, answerId: 28 },
      { vote: false, userId: 6, answerId: 23 },
      { vote: true, userId: 4, answerId: 24 },
      { vote: true, userId: 2, answerId: 25 },
      { vote: false, userId: 2, answerId: 26 },
      { vote: false, userId: 6, answerId: 27 },
      { vote: true, userId: 1, answerId: 28 }
    ], {});
  },
